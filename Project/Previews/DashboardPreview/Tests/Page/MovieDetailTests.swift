...
final class MovieDetailTests: XCTestCase {
  ...
  func test_routeToKeyword_case() async {
    ...
    let pick: MovieEntity.MovieDetail.MovieCard.KeywordItem = (ResponseMock().response.movieCard.successValue.keywordBucket
      .keywordItem?.first)!
  ...
  func test_routeToSimilarMovie_case() async {
    ...
    let pick: MovieEntity.MovieDetail.SimilarMovie.Response.Item = ResponseMock().response.similarMovie.successValue.itemList.first!
  ...
  func test_routeToRecommendedMovie_case() async {
    ...
    let pick: MovieEntity.MovieDetail.RecommendedMovie.Response.Item = ResponseMock().response.recommendedMovie.successValue.itemList.first!
