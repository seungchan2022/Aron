...
//      CreditUseCase: CreditUseCasePlatform(),
...
struct AppContainerMock: CreditEnvironmentUsable {
  ...
  private init(
    ...
    CreditUseCaseStub: CreditUseCaseStub,
    ...
    linkNavigatorMock: TabLinkNavigatorMock)
  {
    ...
    self.CreditUseCaseStub = CreditUseCaseStub
  ...
  let CreditUseCaseStub: CreditUseCaseStub
