...
internal enum Asset {
  internal enum ColorChip {
    internal enum Background {
      ...
      internal static let backgroundTheme = ColorAsset(name: "BackgroundTheme")
    }
    internal enum Error {
    ...
    internal enum Tint {
      ...
      internal static let tintOrange = ColorAsset(name: "TintOrange")
      ...
      internal static let tintYellow = ColorAsset(name: "TintYellow")
    }
  }
}
