...
enum Asset {
  enum ColorChip {
    ...
    enum Label {
      ...
      static let labelGreenSlate = ColorAsset(name: "LabelGreenSlate")
      static let labelOcher = ColorAsset(name: "LabelOcher")
    }
    ...
    enum Tint {
      ...
      static let tintOrange = ColorAsset(name: "TintOrange")
      ...
      static let tintYellow = ColorAsset(name: "TintYellow")
    }
  }
}
