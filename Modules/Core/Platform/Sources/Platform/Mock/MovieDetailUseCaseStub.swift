...
extension MovieDetailUseCaseStub: MovieDetailUseCase {
  public var movieCard: (MovieEntity.MovieDetail.MovieCard.Request) -> AnyPublisher<MovieEntity.MovieDetail.MovieCard.Response, CompositeErrorRepository> {
    { [weak self] _ in
      guard let self else {
  ...
  public var review: (MovieEntity.MovieDetail.Review.Request) -> AnyPublisher<MovieEntity.MovieDetail.Review.Response, CompositeErrorRepository> {
    { [weak self] _ in
      guard let self else {
        return Fail(error: CompositeErrorRepository.invalidTypeCasting)
          .eraseToAnyPublisher()
  ...
  public var credit: (MovieEntity.MovieDetail.Credit.Request) -> AnyPublisher<MovieEntity.MovieDetail.Credit.Response, CompositeErrorRepository> {
    { [weak self] _ in
      guard let self else {
        return Fail(error: CompositeErrorRepository.invalidTypeCasting)
          .eraseToAnyPublisher()
  ...
  public var similarMovie: (MovieEntity.MovieDetail.SimilarMovie.Request) -> AnyPublisher<MovieEntity.MovieDetail.SimilarMovie.Response, CompositeErrorRepository> {
    { [weak self] _ in
      guard let self else {
        return Fail(error: CompositeErrorRepository.invalidTypeCasting)
          .eraseToAnyPublisher()
  ...
  public var recommendedMovie: (MovieEntity.MovieDetail.RecommendedMovie.Request) -> AnyPublisher<MovieEntity.MovieDetail.RecommendedMovie.Response, CompositeErrorRepository> {
    { [weak self] _ in
      guard let self else {
        return Fail(error: CompositeErrorRepository.invalidTypeCasting)
          .eraseToAnyPublisher()
