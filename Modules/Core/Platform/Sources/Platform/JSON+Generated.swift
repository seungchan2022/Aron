...
internal enum Files {
  ...
  internal static let fanClubFailureJson = File(name: "fan_club_failure", ext: "json", relativePath: "", mimeType: "application/json")
  /// fan_club_success.json
  internal static let fanClubSuccessJson = File(name: "fan_club_success", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_detail_credit_failure.json
  internal static let movieDetailCreditFailureJson = File(name: "movie_detail_credit_failure", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_detail_credit_success.json
  internal static let movieDetailCreditSuccessJson = File(name: "movie_detail_credit_success", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_detail_movie_card_failure.json
  internal static let movieDetailMovieCardFailureJson = File(name: "movie_detail_movie_card_failure", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_detail_movie_card_success.json
  internal static let movieDetailMovieCardSuccessJson = File(name: "movie_detail_movie_card_success", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_detail_recommended_failure.json
  internal static let movieDetailRecommendedFailureJson = File(name: "movie_detail_recommended_failure", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_detail_recommended_success.json
  internal static let movieDetailRecommendedSuccessJson = File(name: "movie_detail_recommended_success", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_detail_review_failure.json
  internal static let movieDetailReviewFailureJson = File(name: "movie_detail_review_failure", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_detail_review_success.json
  internal static let movieDetailReviewSuccessJson = File(name: "movie_detail_review_success", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_detail_similar_failure.json
  internal static let movieDetailSimilarFailureJson = File(name: "movie_detail_similar_failure", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_detail_similar_success.json
  internal static let movieDetailSimilarSuccessJson = File(name: "movie_detail_similar_success", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_discover_genre_failure.json
  internal static let movieDiscoverGenreFailureJson = File(name: "movie_discover_genre_failure", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_discover_genre_success.json
  internal static let movieDiscoverGenreSuccessJson = File(name: "movie_discover_genre_success", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_discover_keyword_failure.json
  internal static let movieDiscoverKeywordFailureJson = File(name: "movie_discover_keyword_failure", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_discover_keyword_success.json
  internal static let movieDiscoverKeywordSuccessJson = File(name: "movie_discover_keyword_success", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_discover_movie_failure.json
  internal static let movieDiscoverMovieFailureJson = File(name: "movie_discover_movie_failure", ext: "json", relativePath: "", mimeType: "application/json")
  /// movie_discover_movie_success.json
  internal static let movieDiscoverMovieSuccessJson = File(name: "movie_discover_movie_success", ext: "json", relativePath: "", mimeType: "application/json")
  ...
  internal static let personImageFailureJson = File(name: "person_image_failure", ext: "json", relativePath: "", mimeType: "application/json")
  /// person_image_success.json
  internal static let personImageSuccessJson = File(name: "person_image_success", ext: "json", relativePath: "", mimeType: "application/json")
  /// person_info_failure.json
  internal static let personInfoFailureJson = File(name: "person_info_failure", ext: "json", relativePath: "", mimeType: "application/json")
  /// person_info_success.json
  internal static let personInfoSuccessJson = File(name: "person_info_success", ext: "json", relativePath: "", mimeType: "application/json")
  /// person_movie_credit_failure.json
  internal static let personMovieCreditFailureJson = File(name: "person_movie_credit_failure", ext: "json", relativePath: "", mimeType: "application/json")
  /// person_movie_credit_success.json
  internal static let personMovieCreditSuccessJson = File(name: "person_movie_credit_success", ext: "json", relativePath: "", mimeType: "application/json")
