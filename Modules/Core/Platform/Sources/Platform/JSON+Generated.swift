...
enum Files {
  ...
  static let movieDiscoverMovieFailureJson = File(
    name: "movie_discover_movie_failure",
    ext: "json",
    relativePath: "",
    mimeType: "application/json")
  /// movie_discover_movie_success.json
  static let movieDiscoverMovieSuccessJson = File(
    name: "movie_discover_movie_success",
    ext: "json",
    relativePath: "",
    mimeType: "application/json")
  ...
  static let movieUpcomingSuccessJson = File(
    ...
    mimeType: "application/json")
  /// my_list.json
  static let myListJson = File(name: "my_list", ext: "json", relativePath: "", mimeType: "application/json")
