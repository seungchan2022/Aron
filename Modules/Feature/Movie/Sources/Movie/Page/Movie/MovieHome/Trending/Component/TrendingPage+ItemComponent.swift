...
// MARK: - TrendingPage.ItemComponent

extension TrendingPage {
  struct ItemComponent {
    let viewState: ViewState
    let tapAction: (MovieEntity.Movie.Trending.Item) -> Void

    @Environment(\.colorScheme) var colorScheme
  }
}

extension TrendingPage.ItemComponent {
...
// MARK: - TrendingPage.ItemComponent + View

extension TrendingPage.ItemComponent: View {
  var body: some View {
...
// MARK: - TrendingPage.ItemComponent.ViewState

extension TrendingPage.ItemComponent {
  struct ViewState: Equatable {
    let item: MovieEntity.Movie.Trending.Item
  }
}
