...
// MARK: - TopRatedPage.ItemComponent

extension TopRatedPage {
  struct ItemComponent {
    let viewState: ViewState
    let tapAction: (MovieEntity.Movie.TopRated.Item) -> Void

    @Environment(\.colorScheme) var colorScheme
  }
}

extension TopRatedPage.ItemComponent {
...
// MARK: - TopRatedPage.ItemComponent + View

extension TopRatedPage.ItemComponent: View {
  var body: some View {
...
// MARK: - TopRatedPage.ItemComponent.ViewState

extension TopRatedPage.ItemComponent {
  struct ViewState: Equatable {
    let item: MovieEntity.Movie.TopRated.Item
  }
}
