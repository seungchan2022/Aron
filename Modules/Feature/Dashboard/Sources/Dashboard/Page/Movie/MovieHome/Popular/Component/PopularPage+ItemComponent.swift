...
// MARK: - PopularPage.ItemComponent

extension PopularPage {
  struct ItemComponent {
    let viewState: ViewState
    let tapAction: (MovieEntity.Movie.Popular.Item) -> Void

    @Environment(\.colorScheme) var colorScheme
  }
}

extension PopularPage.ItemComponent {
...
// MARK: - PopularPage.ItemComponent + View

extension PopularPage.ItemComponent: View {
  var body: some View {
...
// MARK: - PopularPage.ItemComponent.ViewState

extension PopularPage.ItemComponent {
  struct ViewState: Equatable {
    let item: MovieEntity.Movie.Popular.Item
  }
}
