...
// MARK: - KeywordPage.ItemComponent

extension KeywordPage {
  struct ItemComponent {
    let viewState: ViewState

    let tapAction: (MovieEntity.Discover.Keyword.Item) -> Void
...
// MARK: - KeywordPage.ItemComponent + View

extension KeywordPage.ItemComponent: View {
  var body: some View {
...
// MARK: - KeywordPage.ItemComponent.ViewState

extension KeywordPage.ItemComponent {
  struct ViewState: Equatable {
    let item: MovieEntity.Discover.Keyword.Item
  }
}
